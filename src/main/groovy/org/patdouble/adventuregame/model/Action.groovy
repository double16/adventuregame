...
enum Action {
    ...
    DROP(1),
    /**
     * Sleep is used to restore health by skipping actions. It is similar to wait but takes either a chronos duration or desired health value before
     * reporting surroundings or requesting action. Actions or other events can awake a player. This does leave a player vulnerable.
     */
    SLEEP(1),
